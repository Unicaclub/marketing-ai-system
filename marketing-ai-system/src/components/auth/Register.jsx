...
import { Bot, Mail, Lock, User, Eye, EyeOff, UserPlus } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSocialLogin = async (provider) => {
    try {
      ...
      alert(`Login com ${provider === 'google' ? 'Google' : 'Facebook'} sera implementado em breve.\n\nEsta funcionalidade requer:\n- Configuracao OAuth\n- Tokens de API\n- Configuracao no backend`);
      
      // For now, just show the intended flow
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary-gradient text-white py-3 px-4 rounded-lg font-medium flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
